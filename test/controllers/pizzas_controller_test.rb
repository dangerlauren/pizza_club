...
class PizzasControllerTest < ActionController::TestCase
  ...
  test "should create pizza" do
    assert_difference('Pizza.count') do
      post :create, pizza: { address: @pizza.address, description: @pizza.description, latitude: @pizza.latitude, longitude: @pizza.longitude, title: @pizza.title }
    end
  ...
  test "should update pizza" do
    patch :update, id: @pizza, pizza: { address: @pizza.address, description: @pizza.description, latitude: @pizza.latitude, longitude: @pizza.longitude, title: @pizza.title }
    assert_redirected_to pizza_path(assigns(:pizza))
  end
